...
def github_create_secret(secret_name: str, secret_value: str) -> None:
    ...
    url_public_key = (
        ...
        "/gitwatch/actions/secrets/public-key"
    )
    ...
    if r.status_code == 200:
        ...
        url_secret = (
            ...
            f"Stephen-RA-King"
            f"/gitwatch/actions/secrets/{secret_name}"
        )
...
def readthedocs_update() -> None:
    ...
    url = "https://readthedocs.org/api/v3/projects/gitwatch/"
    header = {"Authorization": f"token {READTHEDOCS_TOKEN}"}
...
def main() -> None:
    ...
    file_path = r"\gitwatch\Lib\site-packages\semantic_release\repository.py"
